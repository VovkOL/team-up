...
urlpatterns = [
    ...
    path("training-sessions/<int:pk>/", TrainingSessionDetailView.as_view(), name="training-session-detail"),
    ...
    path("training-sessions/<int:pk>/delete/", TrainingSessionDeleteView.as_view(), name="training-session-delete"),
]
